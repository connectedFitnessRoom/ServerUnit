...
case class Set(id: Int, sessionID: Long, machineID: Int, beginDate: LocalDateTime, endDate: Option[LocalDateTime], repetitions: Option[Int], weight: Float)

case class Machine(machineID: Int, machineName: String)

case class Repetition(number: Int, setID: Int, sessionID: Long, machineID: Int, timer: Int, distance: Int)
